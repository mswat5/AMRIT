...
const steps = [
  {
    ...
    fields: ['ambulanceName', 'location', 'status']
  },
  {
    id: 'Step 2',
                ...
                <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
                  <div className='sm:col-span-3'>
                    <p className='block text-sm font-medium leading-6 text-gray-900'>
                      Ambulance Name: 
                      <div className='mt-2'>
                      <p className='block w-full rounded-md p-1.5 text-gray-900 shadow-sm sm:text-sm sm:leading-6'>{watch('ambulanceName')}</p></div>
                    </p>
                  </div>
                  <div className='sm:col-span-3'>
                    <p className='block text-sm font-medium leading-6 text-gray-900'>
                      Location:
                      <div className='mt-2'>
                      <p className='block w-full rounded-md p-1.5 text-gray-900 shadow-sm sm:text-sm sm:leading-6'> {watch('location')}</p></div>
                    </p>
                  </div>
                  <div className='sm:col-span-3'>
                    <p className='block text-sm font-medium leading-6 text-gray-900'>
                      Status:    <div className='mt-2'>
                      <p className='block w-full rounded-md p-1.5 text-gray-900 shadow-sm sm:text-sm sm:leading-6'>{watch('status')}</p></div>
                    </p>
                  </div>
                  <div className='sm:col-span-3'>
                    <p className='block text-sm font-medium leading-6 text-gray-900'>
                      Contact Info:    <div className='mt-2'>
                      <p className='block w-full rounded-md p-1.5 text-gray-900 shadow-sm sm:text-sm sm:leading-6'>{watch('contactInfo')}
                        </p></div>
                    </p>
                  </div>
                  <div className='sm:col-span-3'>
                    <p className='block text-sm font-medium leading-6 text-gray-900'>
                      Certification ID:    <div className='mt-2'>
                      <p className='block w-full rounded-md p-1.5 text-gray-900 shadow-sm sm:text-sm sm:leading-6'>{watch('certificationId')}</p></div>
                    </p>
                  </div>
                </div>
              </motion.div>
