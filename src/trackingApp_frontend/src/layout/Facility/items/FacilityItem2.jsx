      ...
      {view === 'cards' && (
        <div>
          ...
          <div className="space-y-4">
            <div onClick={() => handleCardClick('report-accident')} className="block p-4 bg-gray-200 rounded-md cursor-pointer">Report Accident</div>
            <div onClick={() => handleCardClick('accident-reported')} className="block p-4 bg-gray-200 rounded-md cursor-pointer">Accidents Reported by Your Facility</div>
            <div onClick={() => handleCardClick('active-accidents')} className="block p-4 bg-gray-200 rounded-md cursor-pointer">List of Active Accidents</div>
            <div onClick={() => handleCardClick('accident-timeline')} className="block p-4 bg-gray-200 rounded-md cursor-pointer">Accident Timeline</div>
            <div onClick={() => handleCardClick('update-accident-status')} className="block p-4 bg-gray-200 rounded-md cursor-pointer">Update Accident Status</div>
          </div>
        </div>
      )}
