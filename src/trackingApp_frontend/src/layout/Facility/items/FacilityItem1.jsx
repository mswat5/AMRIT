...
const FacilityItem1 = () => {
  ...
  return (
    <div>
      {view === 'cards' && (
        <div>
          ...
          <div className="space-y-4">
            <div onClick={() => handleCardClick('admit')} className="block p-4 bg-gray-200 rounded-md cursor-pointer">Admit Patient</div>
      ...
      {view === 'form' && (
        <div>
          <button onClick={handleBackClick} className=" p-2 pl-4 text-black rounded-md mb-4 flex gap-x-4 font-semibold text-xl">
