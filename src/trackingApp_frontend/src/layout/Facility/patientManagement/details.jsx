      ...
      cell: ({ row }) => (
       ...
       text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6"
                  ...
                  <p className="mt-5 text-gray-600">
                    ...
                    Registry, you wil be redirected to Logbook Page. It is
                    mandatory to fil the unregistered cases in the logbook.
                  </p>
                  ...
                  <div className="mt-10 flex flex-col gap-x-6 gap-y-8">
                    ...
                    <div className="flex flex-col gap-y-4">
                      <label
                        ...
                        className="block text-sm font-medium leading-6 text-gray-900"
                      >
                        Smokeless Tobacco Status [Paan with tobacco, Gutka
                        Etc.]*
                      </label>
                      <div className="flex gap-x-4">
                        <input
                  ...
                  <div className="mt-8 flex flex-col  gap-x-6 gap-y-8 ">
                    ...
                    <div>
                      <label className="block text-sm font-medium leading-6 text-gray-900 mb-2">
                        Mode of Transport to First Medical Contact/Spoke
                        Facility*
                      </label>
                      <div className="flex gap-x-4">
                        <div className="flex items-center">
                        ...
                        <div className="flex flex-col gap-y-2">
                          ...
                          <div className="flex items-center">
                            <input
                              ...
                              id="pacedRhythm"
                              {...register(
                                "otherAbnormalityDetails.pacedRhythm"
                              )}
                            />
                            <label
                              htmlFor="pacedRhythm"
                        ...
                        <>
                          <div className="ml-4">
                            ...
                            <input
                              ...
                              {...register("randomGlucoseUnit")}
                            />
                            <label htmlFor="randomGlucoseUnit2">
                              mg per dl
                            </label>
                          </div>
                          <input
                        ...
                        <>
                          <div className="ml-4">
                            ...
                            <input
                              ...
                              {...register("fastingGlucoseUnit")}
                            />
                            <label htmlFor="fastingGlucoseUnit2">
                              mg per dl
                            </label>
                          </div>
                          <input
                            ...
                            <div className="flex gap-x-4">
                              <div>
                                <input
                                  ...
                                  id="tenecteplase"
                                  {...register(
                                    "thrombolyticAgents.tenecteplase"
                                  )}
                                />
                                <label htmlFor="tenecteplase">
                                  Tenecteplase
                                </label>
                              </div>
                              <div>
                                <input
                                  ...
                                  id="streptokinase"
                                  {...register(
                                    "thrombolyticAgents.streptokinase"
                                  )}
                                />
                                <label htmlFor="streptokinase">
                                  Streptokinase
                                </label>
                              </div>
                              <div>
                          ...
                          <div className="mt-4">
                            ...
                            <div className="flex gap-x-4">
                              ...
                              <div>
                                ...
                                />
                                <label htmlFor="culprit_left_main">
                                  Left Main
                                </label>
                              </div>
                              <div>
