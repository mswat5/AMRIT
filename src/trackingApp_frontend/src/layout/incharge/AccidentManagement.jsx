...
const data = Array.from({ length: 50 }, (_, i) => ({
  id: (i + 1).toString(),
  details: `Details about accident ${i + 1}`,
  status: i % 2 === 0 ? "Reported" : "Resolved",
...
const AccidentManagementTable = () => {
  ...
  return (
    <div className="p-4 min-h-screen dark:bg-[conic-gradient(at_bottom_right,_var(--tw-gradient-stops))] from-blue-700 via-blue-800 to-gray-900 flex flex-col items-center">
      <h1 className="text-2xl font-bold mb-4">Accident Management</h1>
      <div className="p-4 flex flex-col items-center overflow-x-auto w-full">
        ...
        <Table className="min-w-full border-separate border-spacing-0">
          <TableCaption>A list of accident reports</TableCaption>
...
export default AccidentManagementTable;
